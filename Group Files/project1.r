...
# we will look at GVIF^(1/2Df) > 2.24 for the 50 % in R_j 
vif(model3a)
...
# We see that cholesterol if affected alot, we should look at other ones.
...
heavy_drinker <- filter(model_predictions, alcohol > 200)
